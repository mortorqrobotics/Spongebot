...
public class DrivetrainSubsystem extends Subsystem {
    ...
    private static final double FRONT_LEFT_ANGLE_OFFSET = -Math.toRadians(25.0);
    private static final double FRONT_RIGHT_ANGLE_OFFSET = -Math.toRadians(295.0);
    private static final double BACK_LEFT_ANGLE_OFFSET = -Math.toRadians(37.0);
    private static final double BACK_RIGHT_ANGLE_OFFSET = -Math.toRadians(306.0);
